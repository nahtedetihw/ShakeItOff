...
@interface SHAKEITOFFPreferencesListController : HBRootListController<UIPopoverPresentationControllerDelegate> {
...
@interface SHAKEITOFFAppearanceSettings: HBAppearanceSettings
@end
